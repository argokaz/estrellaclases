 ...
 * delete-task.js
 *
 * POST /.netlify/functions/delete-task
 * Body: { pw, key }   — key es el id del registro en tareas
 *
 * Creado 16 jul 2026 para corregir entregas mal asignadas por el bug de
 * matching de nombres (ver _nameUtils.findBestPerson). Simétrico a delete-result.
 */
